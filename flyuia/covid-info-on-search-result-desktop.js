		...
		covid_img_src: 'https://i.ibb.co/QXrCTqw/mau-corona.png',
 		...
 		depending_on_country: {
 			ru: {
 				...
 				"TLV-KBP": {
 					top_box_text_1: '<span>Бесплатное изменение дат</span><br>Если планы изменятся, самостоятельно<br>меняйте даты путешествия',
 					top_box_text_2: 'Те, кто приезжает из “красной зоны” могут на выбор: установить ”Дій.Вдома”<br>и провести 14 дней на самоизоляции, либо сдать тест на COVID-19 (не более чем за 48<br>часов до пересечения границ, и при условии отрицательного результата не проходить самоизоляцию.',
 				},
 				"KBP-IST": {
 					top_box_text_1: '<span>Бесплатное изменение дат</span><br>Если планы изменятся, самостоятельно<br>меняйте даты путешествия',
 				...
 				"KBP-DXB": {
 					top_box_text_1: '<span>Бесплатное изменение дат</span><br>Если планы изменятся, самостоятельно<br>меняйте даты путешествия',
 					top_box_text_2: 'Все пассажиры, которые летят в Дубай из любого города, должны<br>иметь распечатанныйотрицательный сертификат ПЦР-теста на COVID-19, а также<br>страховой полис,который покрывает расходы на лечение COVID-19.',
 				},
 				"DXB-KBP": {
 					top_box_text_1: '<span>Бесплатное изменение дат</span><br>Если планы изменятся, самостоятельно<br>меняйте даты путешествия',
 					top_box_text_2: 'Въезд для граждан и резидентов Украины свободный. Иностранным гражданам<br>необходимо иметь страховой полис, который покрывает расходы на лечение COVID-19.',
 			...
 			uk: {
 				...
 				"KBP-DXB": {
 					top_box_text_1: '<span>Безкоштовна зміна дат</span><br>Якщо плани зміняться, самостійно<br>змінюйте дати подорожі',
 					top_box_text_2: 'Усі пасажири, які подорожують до Дубая з будь-якого міста,<br>повинні мати роздрукований негативний сертифікат ПЛР-тесту на COVID-19, а також<br>страховий поліс, який покриває витрати на лікування COVID-19.',
 				},
 				"DXB-KBP": {
 					top_box_text_1: '<span>Безкоштовна зміна дат</span><br>Якщо плани зміняться, самостійно<br>змінюйте дати подорожі',
 					top_box_text_2: 'В’їзд для громадян та резидентів України вільний. Іноземним громадянам<br>необхідно мати страховий поліс, який покриває витрати на лікування COVID-19.',
 			...
 			en: {
 				"KBP-TLV": {
 					...
 					top_box_text_2: 'Citizens or residents of Israel and foreigners with permission<br>to enter Israel entering the territory of the country from a country belonging to the<br>red zone must be quarantined and fill out a report on the passage of quarantine',
 				},
 				"TLV-KBP": {
 					top_box_text_1: '<span>Free date change</span><br>Book with confidence and, if needed, change travel dates yourself',
 					top_box_text_2: 'Those who come from the “red zone” can choose to install ”Diy.Home” and<br>spend 14 days in self-isolation, or take a COVID-19 test (no more than 48 hours before<br>crossing the border, and if the result is negative, no self-isolate.',
 				},
 				"KBP-IST": {
 					top_box_text_1: '<span>Free date change</span><br>Book with confidence and, if needed, change travel dates yourself',
 				...
 				"KBP-DXB": {
 					top_box_text_1: '<span>Free date change</span><br>Book with confidence and, if needed, change travel dates yourself',
 					top_box_text_2: 'All passengers travelling to Dubai from any destination<br>must have a printed negative COVID-19 PCR test certificate and also an insurance<br>that covers the costs of COVID-19 treatment.',
 				},
 				"DXB-KBP": {
 					top_box_text_1: '<span>Free date change</span><br>Book with confidence and, if needed, change travel dates yourself',
 					top_box_text_2: 'Entry is free for Ukrainian citizens and residents. Foreign citizens are<br>allowed to enter if they have an insurance that covers the costs of COVID-19 treatment.',
